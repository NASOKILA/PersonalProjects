...
namespace Producer
{
    ...
    {
        private const string EventHubConnectionString = "Endpoint=sb://eventhubatanasexample.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=RZolzxmYrG08poYQDi2QV8IEwJbK3/6EMv+UroLyXuM=";

        private const string EventHubName = "eventhuboneatanasexample";
