...
namespace WebApp_OpenIDConnect_DotNet
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ADD POLICY TO USE AD GROUPS, USE IT LIKE THAT [Authorize("DivisionManager")]
            services.AddAuthorization(options => {
                options.AddPolicy("DivisionManager", policyBuilder => policyBuilder.RequireClaim("groups", "fc511d22-6fee-490b-9546-17c55d29ae7a"));
            });
